# PowerShell script to start all services with PM2 in production mode
Write-Host "=== Starting Blog Microservices with PM2 (Production Mode) ===" -ForegroundColor Green
...
Write-Host "Starting microservices with PM2..." -ForegroundColor Yellow
...
Write-Host "=== Services started successfully in Production Mode! ===" -ForegroundColor Green
...
Write-Host ""
Write-Host "Microservices (PM2 - Production):" -ForegroundColor Cyan
...
Write-Host "  - Frontend (Standalone): http://localhost:3000" -ForegroundColor White
Write-Host ""
...
Write-Host ""
Write-Host "Note: Frontend is running in production mode with standalone build." -ForegroundColor Yellow
Write-Host "For development mode with hot reload, use .\start-with-pm2-dev.ps1" -ForegroundColor Yellow
